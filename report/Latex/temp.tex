...
\indent \indent \textbullet \ Thao tác với DOM dựa trên CSS Selector

\indent \indent \textbullet \ Sư kiện (event)

\indent \indent \textbullet \ Tạo chuyển động

\indent \indent \textbullet \ Hỗ trợ AJAX

\indent \indent \textbullet \ Có thể mở rộng thông qua các plug-in

\indent \indent \textbullet \ Được hỗ trợ bởi nhiều trình duyệt

\indent \indent \textbullet \ Cập nhật và hỗ trợ các công nghệ web mới nhất (HTML5 \& CSS3)
