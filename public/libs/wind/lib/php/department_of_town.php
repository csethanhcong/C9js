...
$query = "SELECT bdnyme_departements.nom_dept, astext(transform(bdnyme_departements.the_geom,4326)) FROM bdnyme_departements, bdnyme_communes WHERE bdnyme_departements.code_dept = bdnyme_communes.depart AND bdnyme_communes.nom_com ILIKE '" . $place . "'";
