...
t.<a href="<?php echo $documentation_path;?>/WIND.Timeline.html#createAnnotation" target="_blank">createAnnotation</a>("<span id="param">Event</span>","<span id="param">World Cup</span>","<span id="param">2014-06-12</span>","<span id="param">2014-07-12</span>");<br><br>
...
- <span id="param">World Cup</span>: The name of the annotation.<br>
- <span id="param">2014-06-12</span>: Starting date.<br>
- <span id="param">2014-07-12</span>: Ending date.<br>
If the starting and the ending date are different, the annotation is an interval.