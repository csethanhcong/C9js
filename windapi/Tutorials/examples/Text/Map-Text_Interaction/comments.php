This example consists of triggering several reactions ("setFeatureStyle", "zoomWith", "zoom", "hide" and "show") on several annotations with a single type of event ("click").<br><br>
...
var m = new <a href="<?php echo $documentation_path;?>/WIND.html" target="_blank">WIND</a>.<a href="<?php echo $documentation_path;?>/WIND.Map.html" target="_blank">Map</a>('<span id="param">map', {'<span id="options">type</span>':'IGN Satellite','<span id="options">zoom</span>':9,'<span id="options">latitude</span>':43.442174,'<span id="options">longitude</span>':-0.973270}</span>)<br><br>
Then we create five annotations with the <a href="<?php echo $documentation_path;?>/WIND.Map.html#createAnnotation" target="_blank">createAnnotation</a>() method.<br><br>
...
var annot4 = m.<a href="<?php echo $documentation_path;?>/WIND.Map.html#createAnnotation" target="_blank">createAnnotation</a>(<span id="param">"Town","ARCANGUES","MULTIPOLYGON(((...)))"</span>);<br>
var annot5 = m.<a href="<?php echo $documentation_path;?>/WIND.Map.html#createAnnotation" target="_blank">createAnnotation</a>(<span id="param">"Town","BIARRITZ","MULTIPOLYGON(((...)))"</span>);<br><br>
...
var react1 = new <a href="<?php echo $documentation_path;?>/WIND.html" target="_blank">WIND</a>.<a href="<?php echo $documentation_path;?>/WIND.ExternalReaction.html" target="_blank">ExternalReaction</a>(<span id="param">annot1, "zoom"</span>);<br><br>
