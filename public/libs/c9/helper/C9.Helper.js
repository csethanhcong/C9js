module.exports = function(Chart) {
    ...
    helpers.setDefaultConfig = function() {
        var self = this;
    ...
    helpers.setValue = function(value, key) {
        var self = this;
        self[key] = value;
    }

    helpers.setPrefix = function(config) {
        var constPrefix = '_';
        if (config) {
    ...
    helpers.isObject = function(object) {
        return typeof object === 'object' && object !== null;
    }

    helpers.isArray = function(array) {
