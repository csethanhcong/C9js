...
WIND.Map.prototype.addDrawing2ToolBar = function (tool) {
    if (tool == "point") {
        ...
        this.drawPoint = new OpenLayers.Control.DrawFeature(this.vectorLayer, OpenLayers.Handler.Point, {
        ...
        this.drawLine = new OpenLayers.Control.DrawFeature(this.vectorLayer, OpenLayers.Handler.Path, {
        ...
        this.drawPolygon = new OpenLayers.Control.DrawFeature(this.vectorLayer, OpenLayers.Handler.Polygon, {
...
WIND.Map.prototype.addToolBar = function () {
    if (this.toolbar == null) {
        ...
        this.drawRegularPolygon = new OpenLayers.Control.DrawFeature(this.vectorLayer, OpenLayers.Handler.RegularPolygon, {
        ...
        this.createMarker = new OpenLayers.Control.InsertIcon(this.vectorLayer, {
        ...
        this.reshapeFeature = new OpenLayers.Control.ModifyFeature(this.vectorLayer, {
        ...
        this.resizeFeature = new OpenLayers.Control.ModifyFeature(this.vectorLayer, {
        ...
        this.dragFeature = new OpenLayers.Control.ModifyFeature(this.vectorLayer, {
            mode: OpenLayers.Control.ModifyFeature.DRAG,
            title: 'Déplacer une figure',
            displayClass: 'olControlDragFeature'
        });
        this.rotateFeature = new OpenLayers.Control.ModifyFeature(this.vectorLayer, {
        ...
        this.removeFeature = new OpenLayers.Control.SelectFeature(this.vectorLayer, {
            'multiple': false,
